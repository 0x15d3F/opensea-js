...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.generateOrderData = function (_b) {
        ...
        var _c = (0, utils_1.assignOrdersToSides)(order, matchingOrder), buy = _c.buy, sell = _c.sell;
        var metadata = this._getMetadata(order, referrerAddress) || constants_1.NULL_BLOCK_HASH;
        return [
            [
                buy.exchange,
                buy.maker,
