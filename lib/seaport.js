...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.generateOrderData = function (_b) {
        ...
        var matchingOrder = this._makeMatchingOrder({
            order: order,
            accountAddress: accountAddress,
            recipientAddress: recipientAddress || accountAddress,
        });
        var _c = assignOrdersToSides(order, matchingOrder), buy = _c.buy, sell = _c.sell;
        var metadata = this._getMetadata(order, referrerAddress) || NULL_BLOCK_HASH;
        return [
            [
                buy.exchange,
                buy.maker,
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, EventType.MatchOrders, "Fulfilling order", function () { return __awaiter(_this, void 0, void 0, function () {
                                var isOpen;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
